...
var uvtestcases = []struct {
	...
	{[]byte("vt 1 1"), &UV{-1, 1, 1, -1}},
	{[]byte("vt 1 1 1"), &UV{-1, 1, 1, 1}},
	{[]byte("vt 0.25 1"), &UV{-1, 0.25, 1, -1}},
	{[]byte("vt 0.25 1 1"), &UV{-1, 0.25, 1, 1}},
	{[]byte("vt 0.25"), nil},
	{[]byte("0.25 1"), nil},
...
func UVsAreEqual(a *UV, b *UV) bool {
